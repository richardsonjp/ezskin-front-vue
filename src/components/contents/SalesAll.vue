<template>
  <b-container fluid style="padding-left:40px;padding-right:40px;">
    <b-col>
      ...
      <b-pagination align="right" :total-rows=" pagination.totalRows" :per-page="pagination.perPage" v-model="pagination.currentPage" class="my-0" @change="fetchSalesAll()" />
    </b-col>
    <b-row>
      <b-col cols="3">
            ...
            <b-row>
              <b-col>
                ...
                <b-form-group 
                  label="Game:"
                  label-for="game">
                  <b-form-select v-model="filters.gameId" :options="gameFilter"></b-form-select>
                </b-form-group>
                <b-form-group 
                  label="Buyer:"
                  label-for="buyer">
...
export default {
  ...
  methods: {
    ...
    sharePagination: function(obj) {
      this.$emit('pagination-count-SalesAll', obj)
    },
    onSubmit: function (e) {
      e.preventDefault()
